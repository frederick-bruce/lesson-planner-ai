...
//       const imgData = canvas.toDataURL("image/pdf", 1.0);
//       const pdf = new jsPDF({
...
//       pdf.addImage(imgData, "PDF", 0, 0, 2550, 3300);
...
//       <DialogContent className="max-w-full max-h-full w-[45vw] h-[95vh]">
...
//           </DialogDescription>
//         </DialogHeader>
//         <div className="flex justify-center overflow-hidde h-full w-full">
//           <div ref={contentRef} className=" p-3 bg-white shadow-lg rounded-lg">
//             {practiceSheet && (
//               <>
